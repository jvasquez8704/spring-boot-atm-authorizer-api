...
@Entity
@Table(name = "paymentInstrumentType")
public class PaymentInstrumentType {
    ...
    @Column(name = "isCreditAllowed", nullable = true)
    private Boolean isCreditAllowed;

    @Column(name = "isDebitAllowed", nullable = true)
    ...
    @ManyToOne
    @JoinColumn(name = "id_customer_creation", nullable = true, foreignKey = @ForeignKey(name = "fk_pi_type_creator"))
    private Customer customerCreation;

    @ManyToOne
    @JoinColumn(name = "id_customer_update", nullable = true, foreignKey = @ForeignKey(name = "fk_pi_type_updater"))
