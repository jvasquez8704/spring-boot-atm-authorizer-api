...
public enum AtmError implements IError{
    ...
    ERROR_03("03","Invalid merchant or service provider"),
    ...
    ERROR_12("12","Invalid transaction"),
    ERROR_13("13","Invalid amount (currency conversion field overflow)"),
    ERROR_14("14","Invalid account number (no such number)"),//In this case is invalid numberPhone
    ...
    ERROR_25("25","Unable to locate record in file, or account number is missing from the inquiry"), /*customer not found*/
    ...
    ERROR_76("76","Unavailable to located previous message (Not match on retrieval reference number)"), /*when does not find atm reference*/
    ERROR_77("77","Previous message located for a repeat or reversal, but repeat or reversal data are inconsistent with original message"),/*when does not find atm reference*/
    ...
    ERROR_81("81","PIN cryptographic error found [error found by VIC security module during PIN decryption]"),
    ...
    ERROR_94("94","Duplicate transactions"),
    ...
    ERROR_N3("N3","Cash service not available"),/*when bank service did not transfer to ATM account*/
    ...
    ERROR_R1("R0","Revocation of authorization order"),
