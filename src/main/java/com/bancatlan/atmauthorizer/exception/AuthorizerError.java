...
public enum AuthorizerError implements IError {
    ...
    * */
    ...
    MISSING_CONFIRM_TARGET_TELEPHONE_FIELD(25,"Confirme teléfono destiono."),
    MISSING_TARGET_TELEPHONE_FIELD(26,"Ingrese teléfono destino."),
    ...
    NOT_MATCH_AMOUNT_WITH_ATM(30,"Los montos permitidos son: Mínimo LPS. 100. Máximo LPS. 4,000 en múltiplos de 100."),
