...
public enum AuthorizerError implements IError {
    ...
    * */
    ...
    MISSING_CONFIRM_TARGET_TELEPHONE_FIELD(25,"El campo confirmar teléfono destiono es obligatorio."),
    MISSING_TARGET_TELEPHONE_FIELD(26,"El campo teléfono destino es obligatorio."),
    NOT_MATCH_CONFIRM_TARGET_TELEPHONE(27,"Campos de teléfono no coinciden."),
    BAD_FORMAT_TARGET_TELEPHONE(28,"El campo teléfono destino no tiene un formato de teléfono válido."),
