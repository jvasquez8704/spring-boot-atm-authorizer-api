...
public class Constants {
    ...
    public static final String STR_URL_SERVICE_PRIVILEGE = "URL_SERVICE_PRIVILEGE";
    public static final String STR_IS_SCHEDULED_SAVINGS_ACCOUNTS = "IS_SCHEDULED_SAVINGS_ACCOUNTS";
    public static final String STR_IS_PRIVILEGE_VALIDATION_ACTIVE ="IS_PRIVILEGE_VALIDATION_ACTIVE";
}
